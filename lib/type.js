...
WidgetType.prototype.createWidgetMarker = function(from, to, opts) {
...
WidgetType.prototype.processChange = function(change) {
    ...
    if (utils.rangesEqual(changeRange, range)) {
...
WidgetType.prototype.onChange = function(inst, change) {
    ...
    if (this._onChange) clearTimeout(this._onChange);
    this._onChange = setTimeout(function() {
